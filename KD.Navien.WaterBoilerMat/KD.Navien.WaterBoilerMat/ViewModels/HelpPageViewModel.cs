...
{
    public class HelpPageViewModel : TabbedItemViewModelBase
    {
        #region Properties
        ...
        public HelpPageViewModel(IPageDialogService dialogService, INavigationService navigationService, ILoggerFacade logger)
